<!--
extract RPC cumulo query Empower
-->

<?php
//error_reporting(0);
$rpc ="https://empower.rpc.cumulo.com.es"; //default value
header('Content-Type: text/html; charset=utf-8');
//choose chain
switch($net=$_REQUEST['chain']){
case $net=="circulus-1";
	$rpc = "https://empower.rpc.cumulo.com.es";
break;
case $net=="";
...
break;
case $pide=="get_token":
$data_json = file_get_contents('https://empower.rpc.cumulo.com.es/genesis?');
$json = json_decode($data_json);
$allData=$json->result;
